...
public partial class AdminRequestingForm
{
    ...
    async Task SubmitRequest()
    {
        ...
        try
        {
            ...
            else
            {
                ...
                _navManager.NavigateTo("/admin/requests");
            }
        }
        catch (Exception e)
        {
    ...
    {
        int hours = Period == "PM" && Hour != 12 ? Hour + 12 : Period == "AM" && Hour == 12 ? 0 : Hour;
        ReliefRequestVM.TargetDateToReceive = ReliefRequestVM.TargetDateToReceive.Date;
